<?php /* C:\Users\giuli\Desktop\TecnologieWeb\ecommerce\vendor\tcg\voyager\src/../resources/views/media/manager.blade.php */ ?>
    ...
    <div class="modal fade modal-info" :id="'create_dir_modal_'+this._uid">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input name="new_folder_name" placeholder="<?php echo e(__('voyager::media.new_folder_name')); ?>" class="form-control" value=""/>
                </div>
    ...
    Vue.component('media-manager', {
        ...
        methods: {
            getFiles: function() {
                var vm = this;
                vm.is_loading = true;
                $.post('<?php echo e(route('voyager.media.files')); ?>', { folder: vm.current_folder, _token: '<?php echo e(csrf_token()); ?>' }, function(data) {
                    vm.files = [];
